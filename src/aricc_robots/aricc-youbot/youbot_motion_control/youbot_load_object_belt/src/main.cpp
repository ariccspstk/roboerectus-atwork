...
//#include <youbot_load_object_belt/ServerConfig.h>
...
public:
  ...
  //typedef youbot_load_object_belt::ServerConfig Config;
  enum StateEnum { ACTIVE = 0, SUCCEEDED, ABORTED };

protected:
  ros::NodeHandle nh_, pnh_, target_nh_;
  actionlib::SimpleActionServer
    <youbot_load_object_belt::LoadAction> action_;
  ...
  youbot_load_object_belt::LoadGoal goal_;
  youbot_load_object_belt::LoadFeedback feedback_;
  youbot_load_object_belt::LoadResult result_;
...
public:
  ...
  StateEnum isGoalValid( youbot_load_object_belt::LoadGoal goal){
  ...
  void setAborted(youbot_load_object_belt::LoadResult result, 
    std::string str = ""){
  ...
  void setSucceeded(youbot_load_object_belt::LoadResult result){
  ...
  void executeCB(const youbot_load_object_belt::LoadGoalConstPtr &goal_msg){
    goal_ = *goal_msg;
...
int main(int argc, char **argv) {
  ros::init(argc, argv, "youbot_load_object_belt_server");
